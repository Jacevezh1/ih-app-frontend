    ...
    return (
        <>
            <div class="text-center">
                <br/>
                <p class="mt-1 text-4xl font-extrabold text-green-600 sm:text-5xl sm:tracking-tight lg:text-6xl">Mexican Origin</p>
            </div>  
            ...
            <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
                ...
                <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                    ...
                    <div class="relative px-8">
                        ...
                        <footer class="mt-4">
                            <p class="text-base font-semibold text-rose-200">Sarah Williams, CEO at Salsa de mi barrio</p>
                        </footer>
                        </blockquote>
                    </div>
                    </div>
