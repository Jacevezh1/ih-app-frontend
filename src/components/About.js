    ...
    return (
        <>
            <div class="text-center">
                <br/>
                <p class="mt-1 text-4xl font-extrabold text-neutral-800 sm:text-5xl sm:tracking-tight lg:text-6xl">Legacy</p>
            </div>  
            ...
            <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
                ...
                <div aria-hidden="true" class="hidden sm:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-screen">
                    <div class="absolute inset-y-0 right-1/2 w-full bg-green-600 rounded-r-3xl lg:right-72"></div>
                ...
                <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                    ...
                    <div class="relative px-8">
                        <div>
                        <img class="h-12" src="https://icon-library.com/images/spice-icon/spice-icon-14.jpg" alt="Logo"/>
                        </div>
                        ...
                        <footer class="mt-4">
                            <p class="text-base font-semibold text-rose-200">Sarah Williams, CEO at Salsa Picante de mi barrio</p>
                        </footer>
                        </blockquote>
                    </div>
                    </div>
                ...
                <div class="mt-10">
                    ...
                    <div class="border-t-2 border-gray-100 pt-6">
                        <dt class="text-base font-medium text-gray-500">Sauces Sold</dt>
                        <dd class="text-3xl font-extrabold tracking-tight text-gray-900">+ 1million</dd>
                    </div>

                    <div class="border-t-2 border-gray-100 pt-6">
                        <dt class="text-base font-medium text-gray-500">Countries</dt>
                        <dd class="text-3xl font-extrabold tracking-tight text-gray-900">Over 7 Countries</dd>
                    </div>
                    </dl>
                    <div class="mt-10">
                    <a href="#" class="text-base font-medium text-rose-500">
                        Learn more about how we're changing the sauce industry
                    </a>
                    </div>
                </div>
                </div>
            ...
            <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                ...
                <div>
                    ...
                    <div class="mt-6">
                    <a href="#" class="text-base font-medium text-rose-500">
                        Meet our investors and advisors and distributors
                    </a>
                    </div>
                </div>
